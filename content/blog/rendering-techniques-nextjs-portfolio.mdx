...
1. Core pages are prebuilt for low-latency delivery.
2. Blog and project detail pages are SSG with deterministic slug generation.
3. Runtime generation is limited to workflows that must execute on demand.
4. Content freshness is controlled through tag-based revalidation, not full rebuilds for every update.
...
1. **Static-first speed vs freshness**
...
2. **SSG scale vs slug discipline**
...
3. **Dynamic flexibility vs runtime cost**
...
4. **Revalidation control vs operational safety**
